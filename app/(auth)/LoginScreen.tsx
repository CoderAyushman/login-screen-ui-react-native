    ...
    >
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <View style={styles.container}>
          ...
          <TextInput placeholder="Email address" style={{ width: '100%' }}  onChangeText={setEmail} />
          </View>
          <View style={styles.passwordContainer}>
            
          <TextInput placeholder="Password" style={{ width: '80%' }} secureTextEntry={!showPassword}  onChangeText={setPassword} />
          <AntDesign name="eye" size={24} color={showPassword?"black":"gray"} onPress={()=>{setShowPassword(!showPassword)}} />
          </View>
          {islogIn ? (
            <View style={{ width: '80%' }}>
